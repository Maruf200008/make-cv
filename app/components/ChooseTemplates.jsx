  ...
  return (
    <div>
      <div className=" flex items-center justify-center space-y-5 text-white my-32 flex-col text-center">
        ...
        <p className=" w-[50%] text-neutral-400 text-lg">
        ...
        <div className=" grid grid-cols-3 gap-10  w-full py-10">
          <div className=" bg-neutral-300 group rounded-xl flex items-center justify-center flex-col gap-y-4 relative">
            ...
            <p className=" absolute flex items-center group-hover:opacity-100 ease-in duration-300 justify-center bg-primary opacity-0 px-10 rounded-full py-3 cursor-pointer ">
              Choose
            </p>
          </div>
