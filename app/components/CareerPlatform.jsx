  ...
  return (
    <div className=" my-20">
      <div className=" flex items-center justify-center flex-col gap-10">
        <h1 className=" text-center text-[50px] font-extrabold">
          A complete career platform
        </h1>
        <div className=" grid grid-cols-3 gap-x-10  gap-y-20 w-full my-10">
          ...
          <div className=" space-y-20 flex items-center flex-col">
            ...
            <div className=" text-center space-y-3">
              ...
              <p className=" text-lg text-neutral-600">
                Be the first to receive relevant jobs based on your profile and
                experience.
              </p>
            </div>
          </div>
          <div className=" space-y-20 flex items-center flex-col">
            ...
            <div className=" text-center space-y-3">
              ...
              <p className=" text-lg text-neutral-600">
                Neatly organise your applications and receive notifications when
                they are viewed.
              </p>
            </div>
          </div>
          <div className=" space-y-14 flex items-center flex-col">
            ...
            <div className=" text-center space-y-3">
              ...
              <p className=" text-lg text-neutral-600">
                Create your CV and cover letter in over 25 different languages.
              </p>
            </div>
          </div>
          <div className=" space-y-14 flex items-center flex-col">
